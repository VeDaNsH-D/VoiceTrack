            ...
            return (
              ...
              >
                ...
                <td className="px-4 py-3 text-sm">
                  <span
                    className={`inline-flex rounded-full px-2.5 py-1 text-xs font-semibold ${
                      row.type === 'Sale' ? 'bg-emerald-100 text-emerald-700' : 'bg-rose-100 text-rose-700'
                    }`}
                  >
                    {row.type}
                  </span>
                ...
                {row.isFirstRow && (
                  <td
                    rowSpan={row.rowSpan}
                    className={`px-4 py-3 align-top text-sm font-semibold whitespace-nowrap ${
                      netIsPositive ? 'text-emerald-700' : 'text-rose-600'
                    }`}
                  >
