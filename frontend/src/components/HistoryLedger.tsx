...
export const HistoryLedger: React.FC<HistoryLedgerProps> = ({ userId, onToggleSidebar, language }) => {
  ...
  return (
    <div className="h-screen overflow-auto bg-slate-100 px-6 pb-10 pt-8">
